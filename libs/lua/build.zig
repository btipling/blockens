...
pub fn buildLibrary(
    ...
    const ziglua = b.addModule("ziglua", .{
        .root_source_file = switch (lua_version) {
            .lua51 => .{ .path = path ++ "/src/ziglua-5.1/lib.zig" },
            .lua52 => .{ .path = path ++ "/src/ziglua-5.2/lib.zig" },
            .lua53 => .{ .path = path ++ "/src/ziglua-5.3/lib.zig" },
            .lua54 => .{ .path = path ++ "/src/ziglua-5.4/lib.zig" },
