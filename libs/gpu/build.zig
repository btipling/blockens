...
const zglfw = @import("../glfw/build.zig");
const zpool = @import("../pool/build.zig");
...
pub const Package = struct {
    ...
    pub fn link(pkg: Package, exe: *std.Build.CompileStep) void {
        ...
        switch (target.os.tag) {
            ...
            .macos => {
                exe.addFrameworkPath(.{ .path = path ++ "/macos12/System/Library/Frameworks" });
                exe.addSystemIncludePath(.{ .path = path ++ "/macos12/usr/include" });
