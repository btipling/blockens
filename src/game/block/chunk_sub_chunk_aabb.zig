...
sub_chunks: [4]*chunk.sub_chunk = undefined,
num_children: usize = 0,
num_sub_chunks: usize = 0,
allocator: std.mem.Allocator,

pub const root_dimension: usize = 500;
...
pub fn addSubChunk(self: *AABB, sc: *chunk.sub_chunk) void {
